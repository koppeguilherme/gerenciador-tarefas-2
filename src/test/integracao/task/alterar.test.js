...
describe("Adicionar uma tarefa", () => {
    ...
    it("Adicionar uma tarefa", async () => {
        ...
        const tarefa = {
            titulo: "Tarefa1 BBBBBBBBBBBBB",
            descricao: "Descrição da tarefa 1",
            status: "pendente",
            projetoId: 1
        }
    
        const { dataValues } = await TarefaController.alterarTarefa(1, tarefa.titulo, tarefa.descricao, tarefa.status, tarefa.projetoId, this.transaction);
